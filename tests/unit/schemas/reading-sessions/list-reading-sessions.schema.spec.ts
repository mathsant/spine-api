...
describe('listReadingSessionsSchema', () => {
  it('defaults limit and allows absent bookId/cursor', () => {
  ...
  it('accepts bookId, cursor and a coerced limit', () => {
    expect(
      listReadingSessionsSchema.parse({ bookId: 'abc123', cursor: 'xyz', limit: '50' }),
    ).toEqual({ bookId: 'abc123', cursor: 'xyz', limit: 50 });
  });
